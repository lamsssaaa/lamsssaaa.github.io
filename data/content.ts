...
export const projects: ProjectItem[] = [
  ...
  { name: '〈Projet 2〉', line: { fr: '〈Une phrase qui résume le projet.〉', en: '〈A line that sums up the project.〉' }, client: { fr: '〈Client〉', en: '〈Client〉' }, tag: { fr: 'Publicité', en: 'Advertising' }, poster: '/images/work-2.jpg', videoHigh: '/video/work-2-high.mp4', videoLow: '/video/work-2-low.mp4' },
